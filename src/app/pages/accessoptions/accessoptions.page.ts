...
@Component({
  selector: 'app-accessoptions',
  templateUrl: './accessoptions.page.html',
  styleUrls: ['./accessoptions.page.scss'],
})
export class AccessoptionsPage implements OnInit {
  ...
  public CarragaMenuAPI() {    
    ...
    //console.log(params);
    this.Authorizer.QueryStoreProc('ExecutarPost', 'spCarregaMenuOptionsAccess', params).then(res => {
