...
export class MenuconfigPage implements OnInit {
  ...
  public AppName: string = 'Configurações'; //environment.AppNameSigla + ' | Configurações';
  ...
  public CarragaMenuConfigAPI() {
    ...
    this.Authorizer.QueryStoreProc('ExecutarPost','spCarregaMenuConfig', params).then(res => {
