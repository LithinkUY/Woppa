...
export class MenusegPage implements OnInit {

  public items: any;
  public itemsMenu: any;
  public MenuOptions: any;
  public AppName: string =  this.Authorizer.formSubTitle; // environment.AppNameSigla + ' | ' +
  ...
  public CarragaMenuAPI() {
    ...
    this.Authorizer.QueryStoreProc('ExecutarPost', 'spCarregaMenuSeg', params).then(res => {
