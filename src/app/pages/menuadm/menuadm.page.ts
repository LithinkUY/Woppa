...
export class MenuadmPage implements OnInit {
  ...
  public AppName: string = 'Administrativo'; //environment.AppNameSigla + ' | Administrativo';
  ...
  public CarragaMenuAPI() {
    ...
    this.Authorizer.QueryStoreProc('ExecutarPost', 'spCarregaMenuAdm', params).then(res => {
