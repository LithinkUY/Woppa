...
import { Faleconoscoassunto } from 'src/app/models/faleconoscoassunto';
...
export class NotificationsPage implements OnInit {
  ...
  public collection: Fale[] = [];
  public collectionFilter: Fale[];
  public model: Fale = new Fale;
  public modelForm: Fale = new Fale;
  public ComentarioLength: any = 0;

  public collectionAssunto: Faleconoscoassunto[] = [];
  public collectionAssuntoFilter: Faleconoscoassunto[];
  public modelAssunto: Faleconoscoassunto = new Faleconoscoassunto;
  public modelAssuntoPesquisa: Faleconoscoassunto = new Faleconoscoassunto;



  public collectionUnidades: Unidades[] = [];
  public collectionUnidadesFilter: Unidades[];
  public modelUnidades: Unidades = new Unidades;
  public modelUnidadesPesquisa: Unidades = new Unidades;
  ...
  */
  ...
  searchItems(ev: any) {
    ...
    this.itemsNotification = this.collection;
    this.items = this.itemsNotification;
    const val = ev.target.value;
    if (val && val.trim() !== '') {
      this.items = this.items.filter((item) => {
        return (
          (item.Assunto.toLowerCase().indexOf(val.toLowerCase()) > -1) ||
          (item.Comentario.toLowerCase().indexOf(val.toLowerCase()) > -1));
      });
    } 
  }
  ...
  read(pPageNumber: number, pRowsPage: number) {
    ...
    this.sendRequest('spFaleConosco', params, (resultado) => {
    ...
    this.sendRequest('spUnidades', params, (resultado) => {
      ...
      this.collectionUnidadesFilter = this.collectionUnidades;      
    }); 
    ...
    this.sendRequest('spFaleConosco', paramsAssuntos, (resultado) => {
      this.collectionAssunto = JSON.parse(atob(resultado.results));
      this.collectionAssuntoFilter = this.collectionAssunto;      
    }); 
    */
  ...
  getLengh() {
    ...
    return this.model.Comentario.length;
  }
  ...
  saveData(form: NgForm) {
    ...
    // -----------------------------------------------------------------
    const params = {
      StatusCRUD: this.model.CodigoFaleConosco > 0 ? 'UPDATE' : 'CREATE',
