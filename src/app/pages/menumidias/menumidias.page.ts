...
export class MenumidiasPage implements OnInit {
  public items: any;
  public itemsMenu: any;
  public MenuOptions: any;
  public flagMenuList: any = true;
  public AppName: string = environment.AppNameSigla + ' | Multmídias';
  ...
  public CarragaMenuAPI() {
    ...
    this.Authorizer.QueryStoreProc('ExecutarPost', 'spCarregaMenuMidia', params).then(res => {
