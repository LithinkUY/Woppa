...
export class MenugerPage implements OnInit {

  public items: any;
  public itemsMenu: any;
  public MenuOptions: any;
  public AppName: string = "AgilFlix Plataform"; //this.Authorizer.formTitle;
  ...
  public CarragaMenuAPI() {
    ...
    this.Authorizer.QueryStoreProc('ExecutarPost', 'spCarregaMenuGerencial', params).then(res => {
