...
var AuthService = /** @class */ (function () {
    function AuthService(http, platform, env, alertService, network, db) {
        this.http = http;
            ...
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_a) {
                    ...
                    return [2 /*return*/, new Promise(function (resolve) {
                            var ParamDataJson = btoa(JSON.stringify(form.value)); // encode string
                            var strDataJson = atob(ParamDataJson); // decode string
                            var StoreProcName = 'spUsuarioAuthentication';
                            var paramUrlAPI = _this.API_HOST + _this.API_URL + '/authentication?';
                            var paramsAPI = 'StoreProcName=' + StoreProcName + '&DataJson=' + ParamDataJson;
                            var EngineAPI = paramUrlAPI + paramsAPI;
                            if (navigator.onLine) {
                                ...
                                _this.coletionsData.subscribe(function (data) {
                                    if (data[0].success) {
                                        ...
                                        _this.Matricula = JSON.parse(resultado)[0].Matricula;
                                    ...
                                    var sucess = data[0].success;
                                    var message = data[0].message;
                                    var results = btoa(ResultsDecode);
                                    var metadata = [];
                                    metadata.push({
                                        Sucess: sucess,
                                        Message: message,
                                    ...
                                    var metadata = [];
                                    var sucess = false;
                                    var message = 'Servidor Indisponível:' + error.status + ' | ' + error.statusText;
                                    var results = [];
                                    metadata.push({
                                        Sucess: sucess,
                                        Message: message,
                                ...
                                var metadata = [];
                                var sucess = false;
                                var message = 'Dispositivo desconectado. Certifique-se de que seu dispositivo tem conexão ativa com a internet.';
                                var results = [];
                                metadata.push({
                                    Sucess: sucess,
                                    Message: message,
    ...
    AuthService.prototype.ConectionInet = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var ipAPI, inet;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        fetch(ipAPI).then(function (response) { return response.json(); }).then(function (data) {
                            return sessionStorage.setItem('SessionIP', data.ip);
                        }).catch(function () { });
                        return [4 /*yield*/, this.network.NetworkStatus(sessionStorage.SessionIP)];
                    case 1:
                        inet = _a.sent();
