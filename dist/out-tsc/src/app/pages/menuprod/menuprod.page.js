...
var MenuprodPage = /** @class */ (function () {
    function MenuprodPage(navCtrl, 
    // public ev: Events,
    ...
    MenuprodPage.prototype.CarragaMenuAPI = function () {
        var _this = this;
        var params = {
        ...
        this.Authorizer.QueryStoreProc('Executar', 'spCarregaMenuProdutos', params).then(function (res) {
            var resultado = res[0];
            try {
    ...
    MenuprodPage.prototype.getItems = function (ev) {
    ...
    MenuprodPage.prototype.itemSelected = function (item) {
    ...
    MenuprodPage.prototype.ngOnInit = function () {
        if (!this.Authorizer.HashKey) {
            this.navCtrl.navigateRoot('/login');
        }
    };
    MenuprodPage.prototype.ionViewDidEnter = function () {
    ...
    MenuprodPage.prototype.ionViewDidLeave = function () {
        // Disparado quando o roteamento de componentes terminou de ser animado.
    ...
    MenuprodPage.prototype.goBack = function () {
        this.navCtrl.back();
    };
    MenuprodPage = tslib_1.__decorate([
        Component({
            selector: 'app-menuprod',
            templateUrl: './menuprod.page.html',
            styleUrls: ['./menuprod.page.scss'],
        }),
...
export { MenuprodPage };
//# sourceMappingURL=menuprod.page.js.map