...
var CursosPage = /** @class */ (function () {
    function CursosPage(ref, cdRef, navCtrl, alertService, Authorizer, env, popoverController, router, platform) {
        this.ref = ref;
        this.cdRef = cdRef;
        ...
        this.subtitle = "Editar Curso"; //this.Authorizer.formSubTitle; 
        ...
        this.modeli = new Cursos;
        this.modelPesquisa = new Cursos;
    ...
    CursosPage.prototype.onPlayerReady = function (api) {
        var _this = this;
    ...
    CursosPage.prototype.onUpdateTime = function (currentTime, duration) {
        // this.modelCursosFilmesComments.DurationEnd = currentTime;
    };
    CursosPage.prototype.currentTimeAPI = function () {
        return this.api.time.current;
    };
    //------------------------------------------------
    // Eventos Angular
    //------------------------------------------------
    CursosPage.prototype.ngAfterViewChecked = function () {
        // console.log("DetectChanges");
        this.cdRef.detectChanges();
        // if ( this.flagFormComment ) this.iComentario.setFocus();
    };
    CursosPage.prototype.ngAfterContentInit = function () {
        // console.log(this.ngAfterContentInit);
    };
    CursosPage.prototype.ngAfterContentChecked = function () {
        // console.log("Aconteceu....");    
    };
    CursosPage.prototype.ngOnChanges = function (changes) {
        var _this = this;
    ...
    CursosPage.prototype.isPortrait = function () {
    ...
    */
    CursosPage.prototype.toggleFullscreen = function ($event) {
        console.log($event);
    };
    CursosPage.prototype.setCurrentVideo = function (source, type) {
        this.api.pause();
    ...
    CursosPage.prototype.trackSelect = function ($event) {
        console.log($event);
        //this.collectionCursoFilmecomments.DurationBegin = this.api.currentTime;
    };
    CursosPage.prototype.play = function () {
        var _this = this;
    ...
    Object.defineProperty(CursosPage.prototype, "currentTime", {
        get: function () {
    ...
    CursosPage.prototype.pause = function () {
        this.elem.dispatchEvent(new CustomEvent(VgEvents.VG_PAUSE));
        this.timerSubs.unsubscribe();
    };
    CursosPage.prototype.onEnterCuePoint = function (e) {
        // console.log('EnterCuePoint:',e);
    };
    CursosPage.prototype.onExitCuePoint = function (e) {
        // console.log('ExitCuePoint',e);
    };
    CursosPage.prototype.getPermissoesModulo = function () {
        var _this = this;
     ...
     */
    CursosPage.prototype.sendRequest = function (procedure, params, next) {
    ...
    CursosPage.prototype.salvar = function (form) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var params;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                params = {
                    StatusCRUD: this.model.CodigoCurso > 0 ? 'UPDATE' : 'CREATE',
                    formValues: this.model,
                };
                this.sendRequest('spCursos', params, function (resultado) {
                    if (params.StatusCRUD === 'CREATE') {
                        ...
                        _this.collectionFilter = _this.collection.map(function (item, index) {
                            if (item.CodigoCurso === _this.model.CodigoCurso) {
    ...
    CursosPage.prototype.delete = function (model) {
        var _this = this;
        ...
        alert.buttons = [
            {
                ...
                handler: function () {
                    ...
                    _this.sendRequest('spCursos', params, function (resultado) {
                        _this.collection.forEach(function (model, index, collection) {
                            if (model.CodigoCurso === this) {
    ...
    CursosPage.prototype.read = function (pPageNumber, pRowsPage) {
        var _this = this;
    ...
    CursosPage.prototype.playForm = function (model) {
    ...
    CursosPage.prototype.playFormClose = function () {
        this.flagForm = false;
    };
    CursosPage.prototype.goBack = function () {
        if (this.flagForm) {
    ...
    CursosPage.prototype.formatMask = function (fieldName, Value, type) {
        this.modeli[fieldName] = this.env.formatMask(Value, type);
        // console.log(value);
    };
    CursosPage.prototype.resetModel = function () {
        // tslint:disable-next-line: forin
        for (var key in this.model) {
            this.model[key] = '';
        }
    };
    CursosPage.prototype.getItems = function (ev) {
    ...
    CursosPage.prototype.submitFiltrar = function (form) {
        this.collectionFilter = this.collection;
        var dados = form.value;
        this.collectionFilter = this.env._findWhere(this.collectionFilter, dados);
    };
    CursosPage.prototype.create = function () {
        this.resetModel();
        this.flagForm = true;
    };
    CursosPage.prototype.mostrarPop = function (ev) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var popover, data;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
    ...
    CursosPage.prototype.player = function (model) {
        // console.log(model);    
        this.playForm(model);
    };
    CursosPage.prototype.edit = function (model) {
        // console.log(model);    
        this.playForm(model);
    };
    CursosPage.prototype.changeSelect = function (modelAttr, e) {
    ...
    */
    CursosPage.prototype.showPages = function (pPageNumber, pRowsPage) {
        this.Paginas = [];
    ...
    CursosPage.prototype.selecionaPagina = function (numero) {
        if (numero < 100) {
    ...
    ], CursosPage.prototype, "iComentario", void 0);
    tslib_1.__decorate([
        Input(),
        tslib_1.__metadata("design:type", Number)
    ], CursosPage.prototype, "duration", void 0);
    CursosPage = tslib_1.__decorate([
        Component({
            selector: 'app-cursos',
...
export { CursosPage };
//# sourceMappingURL=cursos.page.js.map