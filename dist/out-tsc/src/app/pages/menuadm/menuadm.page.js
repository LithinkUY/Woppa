...
var MenuadmPage = /** @class */ (function () {
    function MenuadmPage(navCtrl, 
    // public ev: Events,
    alertService, Authorizer) {
        ...
        this.AppName = environment.AppNameSigla + ' | Administrativo';
    }
    MenuadmPage.prototype.CarragaMenuAPI = function () {
        var _this = this;
        var params = {
        ...
        this.Authorizer.QueryStoreProc('Executar', 'spCarregaMenuAdm', params).then(function (res) {
            var resultado = res[0];
            try {
    ...
    MenuadmPage.prototype.getItems = function (ev) {
    ...
    MenuadmPage.prototype.itemSelected = function (item) {
    ...
    MenuadmPage.prototype.ngOnInit = function () {
        if (!this.Authorizer.HashKey) {
            this.navCtrl.navigateRoot('/login');
        }
    };
    MenuadmPage.prototype.ionViewDidEnter = function () {
    ...
    MenuadmPage.prototype.ionViewDidLeave = function () {
        // Disparado quando o roteamento de componentes terminou de ser animado.
    ...
    MenuadmPage.prototype.goBack = function () {
        this.navCtrl.back();
    };
    MenuadmPage = tslib_1.__decorate([
        Component({
...
export { MenuadmPage };
//# sourceMappingURL=menuadm.page.js.map