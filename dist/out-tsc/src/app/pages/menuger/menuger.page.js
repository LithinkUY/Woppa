...
var MenugerPage = /** @class */ (function () {
    function MenugerPage(navCtrl, 
    // public ev: Events,
    alertService, Authorizer) {
        this.navCtrl = navCtrl;
        this.alertService = alertService;
        this.Authorizer = Authorizer;
        this.AppName = environment.AppNameSigla + ' | Gerencial';
    }
    MenugerPage.prototype.CarragaMenuAPI = function () {
        var _this = this;
        var params = {
        ...
        this.Authorizer.QueryStoreProc('Executar', 'spCarregaMenuGerencial', params).then(function (res) {
            var resultado = res[0];
            try {
    ...
    MenugerPage.prototype.getItems = function (ev) {
    ...
    MenugerPage.prototype.itemSelected = function (item) {
    ...
    MenugerPage.prototype.ngOnInit = function () {
        if (!this.Authorizer.HashKey) {
            this.navCtrl.navigateRoot('/login');
        }
    };
    MenugerPage.prototype.ionViewDidEnter = function () {
    ...
    MenugerPage.prototype.ionViewDidLeave = function () {
        // Disparado quando o roteamento de componentes terminou de ser animado.
    ...
    MenugerPage.prototype.goBack = function () {
        this.navCtrl.back();
    };
    MenugerPage = tslib_1.__decorate([
        Component({
            selector: 'app-menuger',
            templateUrl: './menuger.page.html',
            styleUrls: ['./menuger.page.scss'],
        }),
...
export { MenugerPage };
//# sourceMappingURL=menuger.page.js.map